...
public:
	PhaseMoireSpin() {
		...
		spotlight->Fade(endThirdSpeedup.ms, startMoire.ms, 0.0f, 1.0f, Easing::CubicIn);
		...
		spotlight->Fade(Time("01:21:966").ms, Time("02:05:545").ms, spotlight->fade, spotlight->fade, Easing::CubicIn);
